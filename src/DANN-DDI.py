...
def DNN():
    ...
    attention_probs = Dense(vector_size * 5,activation='relu',use_bias=True, kernel_initializer='glorot_uniform',bias_initializer='zeros')(train_input)

    att = Dense(vector_size * 5,activation='softmax', kernel_initializer='random_uniform')(attention_probs)
